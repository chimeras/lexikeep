...
export default function Home() {
  return (
    <section className="mx-auto max-w-6xl px-6 py-20">
      <div className="grid gap-8 rounded-3xl bg-white p-10 shadow-sm ring-1 ring-gray-200 md:grid-cols-2 md:items-center">
        <div>
        ...
        <div className="rounded-2xl bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50 p-8">
